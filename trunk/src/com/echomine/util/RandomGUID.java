...
public class RandomGUID extends Object {
    ...
    /**
     * returns the string that does not contain dashes (as in toString()).
     * This is mainly for those other methods that do not require dashes
     */
    ...
    public byte[] getGUIDBytes() {
        return HexDec.convertHexStringToBytes(valueAfterMD5);
    }

    /**
     * equality is checked using the GUID string
     */
    public boolean equals(Object obj) {
        if (obj == null) return false;
        if (obj == this) return true;
        if (!(obj instanceof RandomGUID)) return false;
        if (valueAfterMD5.equals(((RandomGUID) obj).getHexString()))
            return true;
        return false;
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer();
        sb.append(valueAfterMD5.substring(0, 8));
        sb.append("-");
        sb.append(valueAfterMD5.substring(8, 12));
        sb.append("-");
        sb.append(valueAfterMD5.substring(12, 16));
        sb.append("-");
        sb.append(valueAfterMD5.substring(16, 20));
        sb.append("-");
        sb.append(valueAfterMD5.substring(20));
