 ...
 */
public class GnutellaRejectedAcceptorProtocolV04 extends AbstractGnutellaProtocol {
    protected final static byte[] RESPONSE_STRING = "GNUTELLA REJECTED\n\n".getBytes();

    public GnutellaRejectedAcceptorProtocolV04(GnutellaConnection connection, RawDataReceivable receiver) {
    ...
    public void handshake(Socket socket) throws HandshakeFailedException {
        ...
        try {
            ...
            throw new HandshakeFailedException("Server Rejected");
    ...
    public int getProtocolType() {
        return GnutellaProtocolType.PROTOCOL_REJECTED_ACCEPTOR_V04;
    }
}
