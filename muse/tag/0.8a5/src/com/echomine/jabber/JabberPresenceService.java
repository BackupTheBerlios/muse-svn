...
public class JabberPresenceService {
    ...
    public void setToUnavailable() throws SendMessageFailedException {
        session.sendMessage(new JabberPresenceMessage(PresenceCode.TYPE_UNAVAILABLE));
    }
    ...
    public void subscribe(JID jid) throws SendMessageFailedException {
        JabberPresenceMessage msg = new JabberPresenceMessage(PresenceCode.TYPE_SUBSCRIBE);
    ...
    public void unsubscribe(JID jid) throws SendMessageFailedException {
        JabberPresenceMessage msg = new JabberPresenceMessage(PresenceCode.TYPE_UNSUBSCRIBE);
        //set the jid
        msg.setTo(jid);
        session.sendMessage(msg);
    }
    ...
    public void sendSubscribed(JID jid) throws SendMessageFailedException {
        JabberPresenceMessage msg = new JabberPresenceMessage(PresenceCode.TYPE_SUBSCRIBED);
        msg.setTo(jid);
        session.sendMessage(msg);
    }
    ...
    public void sendUnsubscribed(JID jid) throws SendMessageFailedException {
        JabberPresenceMessage msg = new JabberPresenceMessage(PresenceCode.TYPE_UNSUBSCRIBED);
        msg.setTo(jid);
        session.sendMessage(msg);
    }
    ...
    public void acceptSubscribe(JabberPresenceMessage msg) throws SendMessageFailedException {
        JabberPresenceMessage reply = new JabberPresenceMessage(PresenceCode.TYPE_SUBSCRIBED);
    ...
    public void denySubscribe(JabberPresenceMessage msg) throws SendMessageFailedException {
        JabberPresenceMessage reply = new JabberPresenceMessage(PresenceCode.TYPE_UNSUBSCRIBED);
        reply.setTo(msg.getFrom());
        session.sendMessage(reply);
    }
}
