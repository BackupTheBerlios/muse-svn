 ...
 * @since 0.8a4
 */
public class OOBIQMessage extends JabberIQMessage {
    private String url;
    ...
    public OOBIQMessage(String type) {
        ...
        getDOM().addContent(new Element("query", JabberCode.XMLNS_IQ_OOB));
    }
    ...
    public JabberMessage parse(JabberMessageParser parser, Element msgTree) throws ParseException {
        ...
        if (query != null) {
            url = query.getChildText("url", JabberCode.XMLNS_IQ_OOB);
            description = query.getChildText("desc", JabberCode.XMLNS_IQ_OOB);
        }
        return this;
    }
    ...
    public String encode() throws ParseException {
        ...
        if (url != null)
            query.addContent(new Element("url", JabberCode.XMLNS_IQ_OOB).addContent(url));
        if (description != null)
            query.addContent(new Element("desc", JabberCode.XMLNS_IQ_OOB).addContent(description));
        x.addContent(query);
        return super.encode();
    }
