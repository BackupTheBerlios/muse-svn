 ...
 */
public class GatewayIQMessage extends JabberIQMessage {
    /** this constructor is for messages with type. */
    public GatewayIQMessage(String type) {
        super(type);
        //add in the query element
        getDOM().addContent(new Element("query", JabberCode.XMLNS_IQ_GATEWAY));
    }
    ...
    public void addField(String name, String value) {
        Element query = getDOM().getChild("query", JabberCode.XMLNS_IQ_GATEWAY);
        //query should definitely exist
        Element field = new Element(name, JabberCode.XMLNS_IQ_GATEWAY);
        if (value != null)
            field.setText(value);
    ...
    public void addFields(HashMap fields) {
        ...
        do {
            ...
            field = new Element(name, JabberCode.XMLNS_IQ_GATEWAY);
            if (value != null)
                field.setText(value);
            query.addContent(field);
        } while (iter.hasNext());
    ...
    public int getMessageType() {
        return JabberCode.MSG_IQ_GATEWAY;
    }
}
